...
menu.onclick = () => {
    ...
    navbar.classList.toggle("open-icon");
};
...
var swiper = new Swiper(".Selling-Slidder", {
    autoplay: {
        delay: 4500,
        disableOnInteraction: false,
    },
...
animate.reveal(".hero-img img,.btn img, .btn, .backpack img,.single-post", { origin: 'bottom' })
